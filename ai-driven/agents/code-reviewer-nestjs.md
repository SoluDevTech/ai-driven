...
skills: code-reviewer, hexagonal-nestjs-patterns, async-nestjs-patterns, performance-audit, test-writer-nestjs
---
...
`AGENT_CONFIRM: code-reviewer-nestjs delegated on step <N> -> score=<S>, critical=<N>`