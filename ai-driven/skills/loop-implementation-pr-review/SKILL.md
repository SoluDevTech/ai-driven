...
- Frontend / React App → invoke the `react-hexagonal` agent and have it use skills: `vercel-react-best-practices`, `performance-audit`. Use OpenDesign MCP, respect the Open Design maquette and the `<app-name>` design system.
